"""
FastAPI REST API Server for EvoFold-Geometry: Invariant Point Attention (IPA) 3D Backbone Frame Generator.
"""
from typing import Dict, Any
from .models import FrontierPayload
from .agents import EvoFoldCoordinator

coordinator = EvoFoldCoordinator()
...
def create_app():
    try:
        ...
        app = FastAPI(
            title="EvoFold-Geometry: Invariant Point Attention (IPA) 3D Backbone Frame Generator",
            description="Constructs SE(3)-equivariant protein backbone frames (T = (R, t)) from residue distance matrices and dihedral angle projections (Phi/Psi/Omega).",
        ...
        @app.get("/health")
        def health():
            return {"status": "HEALTHY", "system": "protein-folding-alpha-geometry", "domain": "Computational Chemistry & AI Drug Discovery", "version": "2.0.0-FRONTIER"}
