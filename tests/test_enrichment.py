"""
Automated Pytest for protein-folding-alpha-geometry Enrichment Modules.
"""
import sys
...
from enrichment import (
    ThreeDMolecularVisualizationWithPymolopenbabelIntegrationEngine,
    ImplementationEngine,
    DependenciesEngine,
    TestingEngine,
    MolecularDynamicsSimulationIntegrationGromacsInputsEngine,
    ImplementationEngine,
    DependenciesEngine,
    TestingEngine,
    ProteinfoldingalphageometryEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = ProteinfoldingalphageometryEnrichmentSuite()
